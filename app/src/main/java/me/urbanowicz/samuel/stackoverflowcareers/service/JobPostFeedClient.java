...
public interface JobPostFeedClient {
    ...
    String FeedForTermQueryPath = "/store/connector/6986fa32-b64c-47d5-a1f4-3035affdf45b";
    @GET(FeedQueryPath)
    ...
    Call<JobPostsFeed> getJobPostFeedCall(@Query("_query?input") String searchTerm, @Query("_apikey") String apiKey);
}
